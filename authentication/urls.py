from .views import RegistrationView, VerificationView, UsernameValidationView, CompletePasswordReset, RequestPasswordResetEmail,  LoginView, LogoutView, EmailValidationView
